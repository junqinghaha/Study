...
public abstract class ArrayAdapter<T> extends BaseAdapter {
	...
	/**
	 * set the element at the specified position to the end of the list
	 * @param position
	 */
	public void setToTail(int position){
		mItems.add(mItems.remove(position));
		if(mNotifyOnChange){
			notifyDataSetChanged();
		}
	}
	...
	/**
	 * reorder the items as the rule of Comparator
	 * @param comparator
	 */
