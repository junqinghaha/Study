...
public class ColorPickerDialog extends Dialog
{
    ...
    private final static String TAG = "Mucai-ColorPickerDialog";
    private final static String TAG_USER_ACTION = "Mucai-用户操作";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        int height = (int) (dMetrics.heightPixels * 0.5f);
        int width = (int) (dMetrics.widthPixels * 0.5f);
        LayoutInflater layoutInflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        LinearLayout linearLayout = (LinearLayout) layoutInflater.inflate(
                R.layout.dialog_color_select, null);

        ColorPickerView myView = null;
        if (this.context.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE)
        {
            Log.i("info", "landscape");
            myView = new ColorPickerView(context, width, height);
        ...
        linearLayout.addView(myView, new LinearLayout.LayoutParams(
