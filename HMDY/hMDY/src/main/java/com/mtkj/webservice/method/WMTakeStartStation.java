 ...
 * 
 */
public class WMTakeStartStation extends BaseWebserviceMothod {

	private final static String TAG = Constants.TAG + "-WMTakeStartStation";
	protected int type;
	/** 保存的数据 */
	public String jsonData = null;

	public WMTakeStartStation() {
		super(WebServiceInfo.METHOD_NAME.StartStation);
