...
public abstract class WebServiceActivity extends BaseActivity {
	 ...
	 * 
	 * @param msgFlag
	 *            参考WebServiceInfo中的参数
	 * @param methodName
	 *            返回结果的函数名,msgFlag==WebServiceInfo.MSG_FAIL时为null
	 * @param result
	 *            返回结果，msgFlag==WebServiceInfo.MSG_FAIL时为null
	 * 
	...
	public void setDialogCancelable(boolean bRet) {
		this.isDlgCancelable = bRet;
	}
			...
			case WebServiceInfo.MSG_WS: {
				if (WebServiceInfo.MSG_SUCCESS == msg.arg1) {
					...
					if (msg.getData() != null) {
						...
						MLog.i(TAG, "网络反馈结果:" + result);
						Util.MsgBox(WebServiceActivity.this, result);
